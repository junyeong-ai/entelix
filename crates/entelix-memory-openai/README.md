...
[![docs.rs](https://docs.rs/entelix-memory-openai/badge.svg)](https://docs.rs/entelix-memory-openai)
[![crates.io](https://img.shields.io/crates/v/entelix-memory-openai.svg)](https://crates.io/crates/entelix-memory-openai)
...
- API reference: <https://docs.rs/entelix-memory-openai>
